// ============================================================
// MODULE: Azure Key Vault — CareAssist Incident Agent
// Centralised secret management for all CareAssist service
// credentials. All services authenticate via Managed Identity.
//
// Secrets provisioned post-deployment:
//   careassist-openai-endpoint
//   careassist-search-endpoint
//   careassist-search-index-name
//   careassist-storage-connection
//   careassist-copilot-studio-secret
// ============================================================
